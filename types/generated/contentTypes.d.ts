...
export interface ApiCampanaCampana extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Configuracion_Global: Schema.Attribute.JSON;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    Tipo: Schema.Attribute.Enumeration<['Gastronomia']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiEventoEvento extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    campana: Schema.Attribute.Relation<'manyToOne', 'api::campana.campana'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    Fecha_Incio: Schema.Attribute.Date;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    mapa: Schema.Attribute.Media<'images' | 'files', true>;
    Nombre: Schema.Attribute.String;
    participacion_locals: Schema.Attribute.Relation<
      'oneToMany',
      'api::participacion-envento.participacion-envento'
    >;
    participacion_usuarios: Schema.Attribute.Relation<
      'oneToMany',
      'api::participacion-usuario.participacion-usuario'
    >;
    publishedAt: Schema.Attribute.DateTime;
    Tipo: Schema.Attribute.Enumeration<['Tapas']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiLocalLocal extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Contacto: Schema.Attribute.Component<'compartido.contacto', true>;
...
export interface ApiParticipacionEnventoParticipacionEnvento
  extends Struct.CollectionTypeSchema {
  collectionName: 'participacion_enventos';
  info: {
    displayName: 'Participacion_Local';
    pluralName: 'participacion-enventos';
    singularName: 'participacion-envento';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiParticipacionUsuarioParticipacionUsuario
  extends Struct.CollectionTypeSchema {
  collectionName: 'participacion_usuarios';
  info: {
    displayName: 'Participacion_Usuario';
    pluralName: 'participacion-usuarios';
    singularName: 'participacion-usuario';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    Consentimiento_Privacidad: Schema.Attribute.Boolean;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    evento: Schema.Attribute.Relation<'manyToOne', 'api::evento.evento'>;
    Foto_Sello: Schema.Attribute.Media<'images', true>;
    ID_Pasaporte: Schema.Attribute.String & Schema.Attribute.Unique;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::participacion-usuario.participacion-usuario'
    ...
    Opt_Sorteo: Schema.Attribute.Boolean;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiVotoVoto extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    participacion_local: Schema.Attribute.Relation<
      ...
      'api::participacion-envento.participacion-envento'
    >;
    participacion_usuario: Schema.Attribute.Relation<
      'oneToOne',
      'api::participacion-usuario.participacion-usuario'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    Acepta_Marketing: Schema.Attribute.Boolean;
